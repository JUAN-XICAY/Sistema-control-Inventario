      ...
      <PageContainer>
        ...
        <Sidebar>
          ...
          <SidebarSection>
            ...
            <SidebarItem to="reporte-kardex">Reporte de Kardex</SidebarItem>
          ...
          <SidebarSection>
            ...
            <SidebarItem to="inventario-valorado-compra" >Precio Compra</SidebarItem>
            <SidebarItem to="inventario-valorado-venta" >Precio Venta</SidebarItem>
          </SidebarSection>
        </Sidebar>
      </PageContainer>
    </Container>
