      ...
      <section className="home">
        <div className="home__container container">
          <div className="home__data">
            <span className="home__subtitle">Page Not Found </span>
            <h1 className="home__title">404 ERROR</h1>
            <p className="home__description">
              Esta página se encuentra disponible en <br /> el sistema de control de inventario
            </p>
          ...
          <div className="home__img">
            ...
            <img src="https://i.ibb.co/GWPBnP6/225203-P29-OZD-286.jpg" alt="" />
          </div>
        </div>
      </section>
    </Container>
